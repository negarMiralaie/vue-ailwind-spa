<template>
    <section class="mt-8 md:p-5%">
        ...
        <section class="bg-customYellow p-2% ml-5% relative mt-8 flex flex-col md:flex-row-reverse ">
            <section class="flex justify-center items-center md:w-2/6">
            ...
            <section class="flex flex-col md:w-4/6">
                ...
                <section class="flex flex-col items-start">
                    <small class="mt-4 text-customGray">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از طراحان شرایط فعلی تکنولوژی مورد نیاز، و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد جوابگوی سوالات پیوسته اهل دنیای موجود طراحی اساسا مورد استفاده قرار گیرد.</small>
